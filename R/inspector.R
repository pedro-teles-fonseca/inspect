...
#'
#' For a complete list of functions see `library(help = "inspector")`. For instructions and examples see the "Usage" section of the [README](https://github.com/pedro-teles-fonseca/inspector/blob/master/README.md).
#'
#' @docType package
#' @keywords internal
