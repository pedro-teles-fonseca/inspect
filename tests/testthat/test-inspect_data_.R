...
test_that("inspect_data_multinom_as_bern warning 1", {
  x <- c(1, 1, NA, 0, 0)
  expect_warning(
    inspect_data_multinom_as_bern(x, success = 1, warning_nas = TRUE),
    "There are NA or NaN values in 'x'."
  )
})
...
test_that("inspect_data_multinom_as_bern warning 2", {
  ...
  success <- 1
  expect_warning(
    inspect_data_multinom_as_bern(x, success = success),
...
test_that("inspect_data_multinom_as_bern error 1", {
  x <- c(1, 1, NA, 0, 0)
  expect_error(
    inspect_data_multinom_as_bern(x, 1, allow_nas = FALSE),
    "Invalid argument: there are NA or NaN values in  'x'."
  )
})
...
test_that("inspect_data_multinom_as_bern error 7", {
  x <- numeric(0)
  expect_error(
    inspect_data_multinom_as_bern(1, x),
    "Invalid argument: 'x' must be atomic and have length 1."
  )
})
...
test_that("inspect_data_multinom_as_bern error 8", {
  expect_error(
    inspect_data_multinom_as_bern(NaN, 1),
    "Invalid argument: all elements of 'NaN' are NA or NaN."
  )
})
...
test_that("inspect_data_multinom_as_bern error 9", {
  expect_error(
    inspect_data_multinom_as_bern(NA, 1),
    "Invalid argument: all elements of 'NA' are NA or NaN."
  )
})
...
test_that("inspect_data_multinom_as_bern error 12", {
  x <- complex(1)
  expect_error(
    inspect_data_multinom_as_bern(x, 1),
    "Invalid argument: the type of 'x' must be 'logical', 'integer', 'double' or 'character'"
  )
})
...
test_that("inspect_data_multinom_as_bern error 13", {
  x <- complex(1)
  expect_error(
    inspect_data_multinom_as_bern(c(1, 0), x),
    "Invalid argument: the type of 'x' must be 'logical', 'integer', 'double' or 'character'"
  )
})
