...
The `inspector` package was built to automate this kind of validation tasks. In the `flip_coins()` example we can use `inspect_par_bernoulli`, since `bias` actually is the parameter of a Bernoulli distribution:
